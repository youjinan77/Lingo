(() => {
  ...
  function pool(){return $('deck').value==='day13'?(window.LINGO_DAY13_WORDS||[]):$('deck').value==='day14'?(window.LINGO_DAY14_WORDS||[]):$('deck').value==='day12'?day12:$('deck').value==='weak'?weak:$('deck').value==='unlearned'?all.filter(w=>!known.includes(w)):all;}
  function start(){
